...
import { getLawsuitsByLawyer, updateLawsuitWithFiles , getLawsuitById, getLawsuitsForCalendar } from "../controllers/lawsuit-trackingForLawyer-controller";
...
router.get("/calendar", authenticateToken, getLawsuitsForCalendar);
